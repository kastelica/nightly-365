...
| [`content/events.json`](content/events.json) | Night pages at `/events/[slug]`: question, blurb, optional setup and expect, pocket doors, how to join, optional agenda and ticket link |
